...
export class PlatformConfig {
  ...
  async render(container) {
    ...
    list.className = 'ms-platform-list';
  ...
  _renderPlatformCard(platform) {
    ...
    if (platform.publishTypes && platform.publishTypes.length > 0) {
      ...
      typesRow.style.cssText = 'display:flex;gap:6px;flex-wrap:wrap';
  ...
  _openPlatformEditor(platform) {
    ...
    modal.style.cssText = 'padding:24px;max-width:500px';
    ...
    typesContainer.style.cssText = 'display:flex;flex-direction:column;gap:8px';
